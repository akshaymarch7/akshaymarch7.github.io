  ...
  return (
    <div className="p-8 h-full overflow-y-auto bg-vscode-bg text-gray-300 font-sans selection:bg-vscode-selection">
      <div className="max-w-3xl mx-auto mt-10">
        ...
        <div className="font-mono text-sm mb-8 bg-[#1e1e1e] p-4 border border-[#333] rounded-md inline-block">
        ...
        <p className="text-lg leading-relaxed mb-6">
          ...
          Creator of <strong className="text-white">Namaste JavaScript</strong> and formerly at Uber & PayTM.
        </p>
        ...
        <div className="mt-16 pt-8 border-t border-[#333]">
           <h3 className="text-sm uppercase tracking-wider text-gray-500 mb-4">Quick Links</h3>
